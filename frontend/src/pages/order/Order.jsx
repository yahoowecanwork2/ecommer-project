  ...
  const createOnlineOrder = async () => {
    try {
      ...
      const options = {
        ...
        amount: data.order.amount, // ✅ FIXED
        currency: "INR",
        name: "Navi Clothing",
        order_id: data.order.id, // ✅ FIXED
      ...
      <div className="max-w-6xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="grid lg:grid-cols-2 gap-24">
          ...
          <div className="space-y-16">
            <section>
              <h2 className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-400 mb-10">
                01. Delivery
              </h2>
              <div className="space-y-8">
                <input
                  ...
                  className="w-full border-b border-gray-100 py-3 outline-none focus:border-[#3D2B3D] transition-all text-sm placeholder:text-gray-300"
                />
            ...
            <section>
              <h2 className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-400 mb-8">
                02. Method
              </h2>
                ...
                {["cod", "online"].map((type) => (
                  ...
                  >
                    <input
                      ...
                      className="accent-[#3D2B3D] w-4 h-4"
                    />
                    <span className="text-[11px] font-bold uppercase tracking-widest">
                      {type === "cod" ? "Cash" : "Online"}
                    </span>
                  </label>
                ))}
              </div>
              ...
              {items.map((item) => (
                ...
                >
                  <span className="font-serif italic text-gray-600">
                    {item.name}{" "}
                    <span className="text-[10px] font-sans not-italic text-gray-300 ml-2">
                      x{item.quantity}
                    </span>
                  </span>
