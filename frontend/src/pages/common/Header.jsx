    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="flex-[2] text-center">
          ...
          >
            Navi{" "}
            <span className="not-italic font-light text-[#D16B92]">
              Clothing.
            </span>
          </Link>
        </div>
        ...
        <div className="flex items-center justify-end gap-5 md:gap-8 flex-1">
          ...
          <Link to="/login" className="hidden lg:flex items-center gap-2 group">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#3D2B3D] group-hover:text-[#D16B92]">
              Login
            </span>
          </Link>
        </div>
      ...
      >
        ...
        >
          ...
          <div className="mt-12 space-y-8">
            <p className="text-[10px] font-black uppercase tracking-[0.5em] text-[#D16B92]">
              Navigation
            </p>
            ...
            <div className="pt-12 border-t border-pink-50">
              ...
              <p className="text-[11px] mt-2 text-gray-500">
                Subscribe for early access to summer drops.
              </p>
            </div>
          </div>
        </div>
