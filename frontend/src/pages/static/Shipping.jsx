    ...
    <div className="font-google bg-white">
      ...
      <section className="pt-44 pb-20 bg-[#FAF9F6]">
        <div className="max-w-5xl mx-auto px-8 text-center space-y-4">
          <p className="text-[10px] font-black uppercase tracking-[0.5em] text-[#D16B92]">Information</p>
          <h1 className="text-5xl md:text-6xl font-serif italic text-[#3D2B3D]">Shipping Policy</h1>
      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-8 space-y-20">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
              <div className="space-y-1">
                <p className="text-sm font-semibold text-[#D16B92]">Metro Cities</p>
                <p className="text-gray-500 font-light italic">2–4 business days</p>
              </div>
              <div className="space-y-1">
                <p className="text-sm font-semibold text-[#D16B92]">Other Cities</p>
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-500 font-light leading-relaxed">
              We offer <span className="text-[#D16B92] font-medium">Free Shipping</span> on all prepaid orders. 
          ...
          <div className="pt-12 border-t border-gray-100 text-center space-y-6">
            <h2 className="text-2xl font-serif italic text-[#3D2B3D]">Need Help?</h2>
