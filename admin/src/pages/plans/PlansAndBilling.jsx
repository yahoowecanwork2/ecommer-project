      ...
      <div className="space-y-8">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-6 py-2 bg-white/5 border border-white/10 text-white text-[10px] font-bold uppercase tracking-widest rounded-sm hover:bg-white/10 transition-all"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto px-4">
          {planTiers.map((plan) => (
            <div
              key={plan.id}
              className={`relative bg-white border ${plan.color} rounded-sm p-8 flex flex-col transition-all duration-500 hover:shadow-md`}
            >
              {plan.recommended && (
              ...
              <button
                className={`w-full py-3 rounded-sm text-[10px] font-bold uppercase tracking-[0.2em] border transition-all flex items-center justify-center gap-2 ${
                  plan.recommended
