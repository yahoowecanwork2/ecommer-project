...
const Home = () => {
  const stats = [
    { id: 1, name: "Total Revenue", value: "₹45,231.89", change: "+12.5%", trendingUp: true, icon: BsCurrencyDollar },
    { id: 2, name: "Orders", value: "356", change: "+8.2%", trendingUp: true, icon: BsCartCheck },
    { id: 3, name: "Active Customers", value: "1,240", change: "-2.4%", trendingUp: false, icon: BsPeople },
    { id: 4, name: "Products Sold", value: "892", change: "+14.1%", trendingUp: true, icon: BsBoxSeam },
  ];

  const recentOrders = [
    { id: "#ORD-7732", customer: "Liam Johnson", status: "Paid", amount: "$125.00", date: "2 mins ago" },
    { id: "#ORD-7731", customer: "Olivia Smith", status: "Pending", amount: "$84.20", date: "15 mins ago" },
    { id: "#ORD-7730", customer: "Noah Williams", status: "Paid", amount: "$210.00", date: "1 hour ago" },
    { id: "#ORD-7729", customer: "Emma Brown", status: "Shipped", amount: "$45.00", date: "3 hours ago" },
  ];
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="border-b border-gray-100 pb-4">
          ...
          <p className="text-xs text-gray-500">Real-time performance metrics for your store.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 border border-gray-200 rounded-sm overflow-hidden">
          {stats.map((item) => (
            <div key={item.id} className="p-5 bg-white flex flex-col justify-between">
              ...
              <div className="mt-4">
                ...
                <div className={`mt-1 inline-flex items-center text-xs font-medium ${item.trendingUp ? "text-green-600" : "text-red-600"}`}>
                  {item.trendingUp ? <HiOutlineArrowTrendingUp className="mr-1" /> : <HiOutlineArrowTrendingDown className="mr-1" />}
                  {item.change}
                  <span className="text-gray-400 ml-1 font-normal text-[10px]">vs last month</span>
                </div>
              </div>
            </div>
          ))}
          ...
          <div className="lg:col-span-2 bg-white border border-gray-200 rounded-sm">
            ...
            <div className="p-4">
              <div className="h-48 w-full bg-gray-50 flex items-end justify-between px-2 pb-1 gap-1">
                {[30, 50, 40, 80, 55, 70, 90, 60, 85, 40, 75, 95].map((height, i) => (
                  <div
                    key={i}
                    style={{ height: `${height}%` }}
              ...
              <div className="flex justify-between mt-2 px-1">
                <span className="text-[10px] text-gray-400 font-medium">01 Mar</span>
                <span className="text-[10px] text-gray-400 font-medium">12 Mar</span>
              </div>
            </div>
          </div>
