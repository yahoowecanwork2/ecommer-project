...
const Userdetail = () => {
  ...
  if (loading)
    return (
      <Layout>
        <div className="p-8 text-xs font-bold uppercase tracking-widest text-gray-400">
          Loading profile...
        </div>
      </Layout>
    );
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-6 flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 text-xs text-gray-500 font-medium">
              ...
              <span className="flex items-center gap-1.5">
                <FaRegCalendarAlt className="text-gray-300" /> Member since{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-gray-200 border border-gray-200 rounded-sm overflow-hidden">
          <div className="bg-white p-6">
            ...
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gray-50 text-gray-900 rounded-sm">
                <FaShoppingCart />
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-sm">
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-gray-900 font-bold underline decoration-gray-200">
                  {user.email}
                </span>
              </div>
              <div className="flex items-center justify-between text-xs">
